...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='movie_api'),
...
TMDB_CACHE_TIMEOUT = config('TMDB_CACHE_TIMEOUT', default=3600, cast=int)  # 1 hour

# Recommendation System Configuration
RECOMMENDATION_CACHE_TIMEOUT = config('RECOMMENDATION_CACHE_TIMEOUT', default=86400, cast=int)  # 24 hours
MAX_RECOMMENDATIONS = config('MAX_RECOMMENDATIONS', default=20, cast=int)
MIN_INTERACTIONS_FOR_COLLABORATIVE = config('MIN_INTERACTIONS_FOR_COLLABORATIVE', default=5, cast=int)
SIMILARITY_THRESHOLD = config('SIMILARITY_THRESHOLD', default=0.1, cast=float)
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@movieapi.com')
